...
const STEPS: Step[] = [
  ...
  {
    icon: CreditCard,
    title: "אישור חבילה ותשלום",
    body: "בוחרים חבילה, חותמים, משלמים בעד 3 תשלומים.",
  },
  {
    icon: Code2,
    title: "בנייה + סבב תיקונים",
    body: "בונים את האתר. שולחים לכם לראות. מתקנים כל מה שצריך.",
  },
  {
    icon: Rocket,
    title: "עולים לאוויר",
    body: "מחברים דומיין, מעלים לאוויר. האתר שלכם חי.",
  },
];
